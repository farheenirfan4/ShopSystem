...
<v-container>
  <v-card class="pa-4 w-100" style="background-color: white;" >
    <v-card-title>
  ...
  @update:sort-by="handleSort"
    ...
    <v-icon v-if="canEdit" small color="primary" class="cursor-pointer" @click="openEditDialog(item)">
    mdi-pencil
  </v-icon>
